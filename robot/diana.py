...
class Diana(Robot):
    ...
    # move_cartesian_with_avoidance removed: Diana uses TracIK which
    # handles singularity avoidance internally via the IK solver.
...
if __name__ == '__main__':
   ...
   # 给定SE3矩阵，求解逆运动学
    ...
    ik_solver = TracIKSolver(
                str((Path(__file__).parent.parent / "assets" / "urdf"
                     / "diana7_description" / "urdf" / "diana_v2.urdf").resolve()),
                "base",
