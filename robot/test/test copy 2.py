...
class DianaMujocoEnv:
    def __init__(self):
        self.diana_controller=DianaRobot(target_frame,visualizer=True)
        self.sim_hz = 500
        self.control_hz = 25
        #存储最近一次的动作
...
# tforms_to_show,t_vec, q_vec,success = robot.cartesian_planning( q_start, tforms,dt)
# print(len(t_vec), len(q_vec))
# # robot.display_trajectory(q_vec, t_vec)

# # Visualize frames in Meshcat
# robot.visualize_frames( tforms_to_show,q_start)
